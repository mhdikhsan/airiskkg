/* Workbench wiring.
 *
 * The entry point: it holds the shared state the panels read, and connects
 * them to the editor and the two canvases. Rendering belongs in the panel
 * modules; anything here that draws is a candidate for moving out.
 */
 ...
 * happened to work. */
window.PairAI = { Editor, GraphView, ProcessCanvas, VersionHistory };
